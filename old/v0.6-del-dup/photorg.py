    ...
    for fileSrc in allFilesSrc:
        for fileTarget in allFilesTarget:
            if (not fileSrc['dupFile'] and
                    fileSrc['sha256'] == fileTarget['sha256'] and
...
def processOptions():
    ...
    global  targetDir, fullChkDup, simMode, delDup, onlyDelDup
